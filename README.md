...
98,913 users on a French-founded C2C fashion marketplace (a global user base across 200 countries). Activation funnel, six behavioural segments, and the finding that a "registered users" metric hides almost everything that matters: around 0.5% of users carry most of the activity. Shipped as a Tableau-ready dataset.
